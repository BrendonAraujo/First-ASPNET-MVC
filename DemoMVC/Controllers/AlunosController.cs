...
namespace DemoMVC.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Date,Active")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Date,Active")] Aluno aluno)
        {
            if (id != aluno.Id)
            {
                return NotFound();
